...
const baseURL = "https://oofinance.darshanrander.com";
...
const String userAgeKey = 'user_age_key';
const String userMatrialStatusKey = 'user_marital_status_key';
const String userEducationKey = 'user_education_key';
const String userCapitalGainKey = 'userCapitalGainKey';
const String userCapitalLossKey = 'userCapitalLossKey';
const String userIncomeKey = 'userIncomeKey';
const String userGenderKey = 'userGenderKey';
